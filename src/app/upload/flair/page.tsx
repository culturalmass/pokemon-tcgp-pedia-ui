...
import { createFlairsItem } from "@/app/actions"
import Button from "@/app/components/ui/custom-button"
import { Input } from "@/app/components/ui/custom-input"
import { FormFlairItemData } from "@/app/types"
import { FlairItemSchema } from "@/app/types/validation-schemas"
import { zodResolver } from "@hookform/resolvers/zod"
import { useRouter } from "next/navigation"
import { useForm } from "react-hook-form"

const UploadTradeTokenItem = () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<FormFlairItemData>({
    resolver: zodResolver(FlairItemSchema),
  })

  const onSubmit = handleSubmit((data) => {
    console.log(data, "data")
    createFlairsItem(data)
  })
  return (
...
export default UploadTradeTokenItem
