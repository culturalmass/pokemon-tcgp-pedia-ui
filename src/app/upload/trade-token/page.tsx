...
import { createTradeTokenItem } from "@/app/actions"
import Button from "@/app/components/ui/custom-button"
import { Input } from "@/app/components/ui/custom-input"
import { FormTradeTokenItemData } from "@/app/types"
import { TradeTokenItemSchema } from "@/app/types/validation-schemas"
...
const UploadTradeTokenItem = () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<FormTradeTokenItemData>({
    resolver: zodResolver(TradeTokenItemSchema),
  })

  const onSubmit = handleSubmit((data) => {
    console.log(data, "data")
    createTradeTokenItem(data)
  })
  return (
